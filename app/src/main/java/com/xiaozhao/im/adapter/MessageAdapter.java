...
import com.xiaozhao.im.SQLiteUtil;
import com.xiaozhao.im.TimeUtil;
import com.xiaozhao.im.ui.ChatActivity;
...
public class MessageAdapter extends RecyclerView.Adapter<MessageAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ViewHolder viewHolder = new ViewHolder(LayoutInflater.
                from(BaseApplication.getContext()).inflate(R.layout.item_conversation, parent, false));
