...
import com.xiaozhao.im.model.LoginModel;
...
public class LoginPresenter implements LoginMVP.Presenter {
    ...
    public LoginPresenter(LoginMVP.View loginView) {
        ...
        mTencent = Tencent.createInstance(ConstantValues.APP_ID, BaseApplication.getContext());
        loginHelper = TLSLoginHelper.getInstance()
                .init(BaseApplication.getContext(), ConstantValues.SDK_APP_ID,
        ...
        if (!mTencent.isSessionValid()) {
            mQQLoginListener = new IUiListener() {
                ...
                public void onComplete(Object o) {
                    Toast.makeText(BaseApplication.getContext(), "该接口暂时未开放", Toast.LENGTH_SHORT).show();
                }
    ...
    private class PwdRegListener implements TLSPwdRegListener {
        ...
        public void OnPwdRegAskCodeSuccess(int i, int i1) {
            Toast.makeText(BaseApplication.getContext(), "短信已发送", Toast.LENGTH_SHORT).show();
        }
        ...
        public void OnPwdRegFail(TLSErrInfo tlsErrInfo) {
            ...
            Toast.makeText(BaseApplication.getContext(), tlsErrInfo.Title + ":" + tlsErrInfo.Msg, Toast.LENGTH_SHORT).show();
        }
            ...
            TIMManager.getInstance().login((int) ConstantValues.SDK_APP_ID,
                    user, userSig, new TIMCallBack() {
                        ...
                        public void onSuccess() {
                            ...
                            Log.d("----", "userSig = " + userSig + "identifier = " + tlsUserInfo.identifier);
...
//                            contactModel.getFriendList();
        ...
        public void OnPwdLoginFail(TLSErrInfo tlsErrInfo) {
            Toast.makeText(BaseApplication.getContext(), tlsErrInfo.Title + ":" + tlsErrInfo.Msg,
