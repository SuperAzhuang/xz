 ...
 */
package com.xiaozhao.zxing.activity;
...
import com.xiaozhao.zxing.camera.CameraManager;
import com.xiaozhao.zxing.decode.DecodeThread;
import com.xiaozhao.zxing.utils.BeepManager;
import com.xiaozhao.zxing.utils.CaptureActivityHandler;
import com.xiaozhao.zxing.utils.InactivityTimer;
...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback,
	...
	private void showPayActity(final String text) {

		// 跳转交易界面
//		Intent intent = new Intent(this, TradeInformationActivity.class);
//		intent.putExtra(ConstantUtils.ORDER_NUMBER, text);
//		LogUtils.v("order_number=" + text);
...
//		finish();
	...
	private void cameraTask() {
		...
		if (EasyPermissions.hasPermissions(this, perms)) {
			...
			EasyPermissions.requestPermissions(this, getResources().getString(R.string.str_request_camera_message),
					CAMERA_PERM, perms);
		}
	}
}