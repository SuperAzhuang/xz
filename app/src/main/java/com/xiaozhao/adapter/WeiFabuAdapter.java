...
public class WeiFabuAdapter extends BaseQuickAdapter<NewsResult.NewsBean, BaseViewHolder> {

    public WeiFabuAdapter(int layoutResId, List<NewsResult.NewsBean> data, Context context) {
