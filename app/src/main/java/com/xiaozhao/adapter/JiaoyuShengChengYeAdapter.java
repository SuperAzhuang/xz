...
public class JiaoyuShengChengYeAdapter extends BaseItemDraggableAdapter<NewsResult.NewsBean, BaseViewHolder> {

    public JiaoyuShengChengYeAdapter(int layoutResId, List<NewsResult.NewsBean> data, Context context) {
