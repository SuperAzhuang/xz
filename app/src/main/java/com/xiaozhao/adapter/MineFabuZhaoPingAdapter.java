...
public class MineFabuZhaoPingAdapter extends BaseQuickAdapter<NewsResult.NewsBean, BaseViewHolder> {

    public MineFabuZhaoPingAdapter(int layoutResId, List<NewsResult.NewsBean> data, Context context) {
