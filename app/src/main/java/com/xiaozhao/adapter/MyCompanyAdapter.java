...
public class MyCompanyAdapter extends BaseQuickAdapter<NewsResult.NewsBean, BaseViewHolder> {

    public MyCompanyAdapter(int layoutResId, List<NewsResult.NewsBean> data, Context context) {
