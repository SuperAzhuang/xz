...
public class MineQiuZhiAdapter extends BaseQuickAdapter<NewsResult.NewsBean, BaseViewHolder> {

    public MineQiuZhiAdapter(int layoutResId, List<NewsResult.NewsBean> data, Context context) {
